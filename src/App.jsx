  ...
  return(
    <>
      <div className="bg-green-200">
          <div className="text-3xl text-green-700 text-center font-extrabold ">
            <p className="p-10">Diferencias entre un sapo de cuevas y un sapo de por ahí</p>
            <img className="w-full rounded-2xl shadow-2xl" src="images/image01.png" alt="" />
          </div>
        
        
          <div className="flex flex-col md:flex-row md:flex-wrap">
            <div className="bg-green-950 md:basis-1/2 lg:basis-1/2 xl:basis-1/2 p-5">
              <img className="w-full p-5 rounded-2xl shadow-2xl" src="images/sapoDeCueva.jpg" alt="Sapo de las cuevas" />
            ...
            <div className="bg-green-400 md:basis-3/5 lg:basis-full xl:basis-1/3 p-5 rounded-2xl">
